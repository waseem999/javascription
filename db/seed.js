...
const seedTiers = () => db.Promise.map([
  {name: 'Good', description: 'This is our base coffee.  Its super untasty and super cheap!!! Almost like dirt!', costpercup: 100, costperpound: 1500, id: 1,
    products: [
      ...
      {photo: '/CoffeePics/Waseems_worts.jpg', roast: 'light', name: "Waseem's Worst", region: "Macedonia", description: "This coffee is almost as fake as the news that our 16 year old internet trolls make up.  You'll love the fake taste and fake smell!"},
